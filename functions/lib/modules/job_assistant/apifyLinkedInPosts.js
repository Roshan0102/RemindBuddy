...
exports.searchLinkedInPostsViaApify = searchLinkedInPostsViaApify;
...
async function searchLinkedInPostsViaApify(options) {
    ...
    if (apiTokens && Array.isArray(apiTokens)) {
        for (const t of apiTokens) {
            ...
            if (trimmed && !tokensToTry.includes(trimmed))
                tokensToTry.push(trimmed);
        }
    }
    ...
    for (let i = 0; i < tokensToTry.length; i++) {
        ...
        try {
            ...
            const errMsg = ((_d = (_c = (_b = err.response) === null || _b === void 0 ? void 0 : _b.data) === null || _c === void 0 ? void 0 : _c.error) === null || _d === void 0 ? void 0 : _d.message) || err.message;
    ...
    for (const item of rawPosts) {
        ...
        const emails = Array.from(new Set(rawEmails.map((e) => e.trim().toLowerCase())))
            .filter((e) => !e.endsWith(".png") && !e.endsWith(".jpg") && !e.endsWith(".jpeg") && !e.includes("example.com"));
...
//# sourceMappingURL=apifyLinkedInPosts.js.map