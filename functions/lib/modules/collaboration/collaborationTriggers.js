...
exports.onCollaborationRequestUpdated = exports.onCollaborationRequestCreated = void 0;
...
exports.onCollaborationRequestCreated = functions.firestore
    ...
    if (!receiverUid)
        return;
    try {
        const usernameDoc = await firebase_1.db.collection("usernames").where("uid", "==", receiverUid).limit(1).get();
        ...
        await (0, logger_1.logNotification)(receiverUid, notifTitle, body, "COLLABORATION_REQUEST");
...
exports.onCollaborationRequestUpdated = functions.firestore
    ...
    if (newData.status === 'approved' && oldData.status !== 'approved') {
        ...
        try {
            ...
            const docRef = firebase_1.db.collection('users').doc(senderUid).collection(subcollection).doc(itemId);
...
//# sourceMappingURL=collaborationTriggers.js.map