...
exports.adminUpdateAllowedCollaborators = exports.adminUpdateUserModules = exports.adminDeleteUser = exports.adminChangePassword = exports.adminCreateUser = void 0;
...
exports.adminCreateUser = functions.runWith({ timeoutSeconds: 60, memory: "256MB" }).https.onCall(async (data, context) => {
    ...
    try {
        ...
        await firebase_1.db.collection('usernames').doc(username).set({
            email: email,
            uid: uid,
...
exports.adminDeleteUser = functions.runWith({ timeoutSeconds: 60, memory: "256MB" }).https.onCall(async (data, context) => {
    ...
    try {
        ...
        try {
            await firebase_1.admin.auth().deleteUser(uid);
        }
        catch (authErr) {
            console.warn("Auth user deletion warning:", authErr.message);
        }
        await firebase_1.db.collection('usernames').doc(username).delete();
