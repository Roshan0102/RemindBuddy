...
class SmsParserService {
  ...
  static String _extractBankName(String sender, String body, [dynamic customHeaderRules]) {
    ...
    final List<_BankMatchRule> bankRules = [
      const _BankMatchRule('HDFC Bank', ['HDFCBK', 'HDFC', 'HDFCB'], ['hdfc bank', 'hdfc']),
      const _BankMatchRule('SBI', ['SBIBNK', 'SBIN', 'SBI', 'SBIUPI'], ['state bank of india', 'state bank', 'sbi', '-sbi']),
      const _BankMatchRule('ICICI Bank', ['ICICIB', 'ICICI'], ['icici bank', 'icici']),
      const _BankMatchRule('Axis Bank', ['AXISBK', 'UTIB', 'AXIS'], ['axis bank', 'axis']),
      const _BankMatchRule('Kotak Bank', ['KOTAKB', 'KOTAK'], ['kotak mahindra', 'kotak bank', 'kotak']),
      const _BankMatchRule('Indian Bank', ['INDNBN', 'INDIBK', 'INDIANB', 'INDN', 'INDB', 'IBK', 'INDBNK'], ['indian bank', 'indianb', 'ind bank', 'indibk', 'indbnk']),
      const _BankMatchRule('Bank of Baroda', ['BOBTXT', 'BOB', 'BARODA'], ['bank of baroda', 'baroda bank', 'bob']),
      const _BankMatchRule('Canara Bank', ['CANBNK', 'CNRB', 'CANARA'], ['canara bank', 'canara']),
      const _BankMatchRule('Union Bank', ['UNIONB', 'UBOI', 'UNIN', 'UBIN', 'UBI'], ['union bank of india', 'union bank', 'uboi', 'ubin']),
      const _BankMatchRule('PNB', ['PNBSMS', 'PNB'], ['punjab national bank', 'pnb']),
      const _BankMatchRule('IndusInd Bank', ['INDUSB', 'INDUS'], ['indusind bank', 'indusind']),
      const _BankMatchRule('IDFC FIRST Bank', ['IDFCFB', 'IDFC'], ['idfc first bank', 'idfc bank', 'idfc']),
      const _BankMatchRule('YES Bank', ['YESBNK', 'YES'], ['yes bank']),
      const _BankMatchRule('Bank of India', ['BOISMS', 'BKID', 'BOI'], ['bank of india', 'boi']),
      const _BankMatchRule('Central Bank', ['CENTRAL', 'CBI'], ['central bank of india', 'central bank']),
      const _BankMatchRule('Indian Overseas Bank', ['IOB'], ['indian overseas bank', 'iob']),
      const _BankMatchRule('UCO Bank', ['UCOBNK', 'UCO'], ['uco bank', 'uco']),
      const _BankMatchRule('Bank of Maharashtra', ['MAHABK'], ['bank of maharashtra', 'mahabank']),
      const _BankMatchRule('Punjab & Sind Bank', ['PSB'], ['punjab & sind', 'punjab and sind']),
      const _BankMatchRule('IDBI Bank', ['IBKL', 'IDBI'], ['idbi bank', 'idbi']),
      const _BankMatchRule('Federal Bank', ['FEDERAL', 'FDRL'], ['federal bank', 'federal']),
      const _BankMatchRule('South Indian Bank', ['SIB'], ['south indian bank', 'sib']),
      const _BankMatchRule('RBL Bank', ['RATN', 'RBL'], ['rbl bank', 'rbl']),
      const _BankMatchRule('Karur Vysya Bank', ['KVB'], ['karur vysya', 'kvb']),
      const _BankMatchRule('City Union Bank', ['CUB'], ['city union bank', 'cub']),
      const _BankMatchRule('Bandhan Bank', ['BANDHAN'], ['bandhan bank', 'bandhan']),
      const _BankMatchRule('AU Small Finance Bank', ['AUBANK', 'AU'], ['au small finance', 'au bank']),
      const _BankMatchRule('Equitas Bank', ['EQUITAS'], ['equitas bank', 'equitas']),
      const _BankMatchRule('Ujjivan Bank', ['UJJIVAN'], ['ujjivan bank', 'ujjivan']),
      const _BankMatchRule('Paytm Bank', ['PAYTM', 'PYTM'], ['paytm payments bank', 'paytm bank', 'paytm']),
      const _BankMatchRule('Airtel Bank', ['AIRTEL'], ['airtel payments bank', 'airtel bank']),
      const _BankMatchRule('IPPB', ['IPPB'], ['india post payments', 'ippb', 'post office bank']),
      const _BankMatchRule('Jio Bank', ['JIO'], ['jio payments bank', 'jio bank']),
      const _BankMatchRule('PhonePe', ['PHONEPE', 'YBL', 'IPL'], ['phonepe']),
      const _BankMatchRule('Google Pay', ['GPAY'], ['google pay', 'gpay']),
      const _BankMatchRule('Fi Money', ['FI'], ['fi money', 'fi bank']),
      const _BankMatchRule('Jupiter Money', ['JUPITER'], ['jupiter money', 'jupiter']),
      const _BankMatchRule('Slice', ['SLICE'], ['slice card', 'slice']),
      const _BankMatchRule('Uni Card', ['UNI'], ['uni card', 'uni pay']),
      const _BankMatchRule('OneCard', ['ONECARD'], ['onecard']),
      const _BankMatchRule('Standard Chartered', ['SCB', 'STANCHART'], ['standard chartered', 'stanchart']),
      const _BankMatchRule('HSBC', ['HSBC'], ['hsbc bank', 'hsbc']),
      const _BankMatchRule('Citibank', ['CITI'], ['citibank', 'citi']),
    ];
